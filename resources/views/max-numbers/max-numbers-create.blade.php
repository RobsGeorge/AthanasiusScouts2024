            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <form class="user" id="regForm" method="POST" action="">
                            @csrf
                            <div class="card-header py-3">
                                <div class="">

                                        <select class="form-control" style="margin-top: 8px; text-align: center; " name="qetaa_id" id="qetaa_id" onselect="" placeholder="اختارالمرحله">
                                        <option style="font-family: 'Cairo', sans-serif; color: black; font-size: large" value="" disabled selected> اختارالمرحله</option>
                                        ...
                                        <input type="text" class="form-control" name="question_text" id="question_text" tyle="font-family: 'Cairo', sans-serif; color: black; font-size: large ; "
                                            placeholder="ادخل الحد الاقصي المطلوب">
                                        <br>
                                        ...
                                        <br>
                                        <input type="submit" class="btn-google btn-user btn-block" style="background-color: brown;" id="submit-button" value="تأكيد ادخال الحد الاقصي"></input>
                                </div>
                            </div>
                        </form>
                    </div>

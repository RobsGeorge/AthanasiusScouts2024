            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <div class="rating">
                        ...
                        <input type="radio" id="leaders_star9" name="leaders_rating" value="9" required><label for="leaders_star9">★</label>
                        <input type="radio" id="leaders_star8" name="leaders_rating" value="8" required><label for="leaders_star8">★</label>
                        <input type="radio" id="leaders_star7" name="leaders_rating" value="7" required><label for="leaders_star7">★</label>
                        <input type="radio" id="leaders_star6" name="leaders_rating" value="6" required><label for="leaders_star6">★</label>
                        <input type="radio" id="leaders_star5" name="leaders_rating" value="5" required><label for="leaders_star5">★</label>
                        <input type="radio" id="leaders_star4" name="leaders_rating" value="4" required><label for="leaders_star4">★</label>
                        <input type="radio" id="leaders_star3" name="leaders_rating" value="3" required><label for="leaders_star3">★</label>
                        <input type="radio" id="leaders_star2" name="leaders_rating" value="2" required><label for="leaders_star2">★</label>
                        <input type="radio" id="leaders_star1" name="leaders_rating" value="1" required><label for="leaders_star1">★</label>
                    </div>
                </div>
                <div class="form-group">

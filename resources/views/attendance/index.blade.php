                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">حضور وغياب المجموعات</h6>
                        </div>
                    </div>

                    <div class="card shadow mb-4">
                        <form class="user" id="regForm" method="POST" action="{{ route('attendance.insert') }}">
                            @csrf
                            <div class="card-header py-3">
                                <div class="col mb-3 mb-sm-0">
                                    <div class="card-header">        
                                        <div class="form-group row" dir="rtl" style="text-align: right">
                                            <label for="group_id" style="font-family: 'Cairo', sans-serif;">اختر الحدث الكشفي</label>
                                            <select class="form-control col-sm-4" style="margin-right: 20px;" name="event_id" id="event_id">
                                                <option style="font-family: 'Cairo', sans-serif; color: black; font-size: large; margin-top: 2px" value="" disabled selected>اختر الحدث الكشفي</option>
                                                @foreach($events as $event)
                                                    <option style="font-family: 'Cairo', sans-serif; color: black;" value="{{$event->EventID}}">{{$event->EventInfo}}</option>
                                                @endforeach
                                            </select>
                                            <button type="submit" 
                                                    class="btn-google btn-user btn-block" 
                                                    style="background-color: rgb(26, 163, 156); width: 20%; margin-right: 5px" 
                                                    id="show-button"
                                                    name="show-button" 
                                                    value=""
                                                    onclick="">
                                                    اضغط هنا لاظهار أفراد المجموعة
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <input  type="submit" 
                                        class="btn-google btn-user btn-block" 
                                        style="background-color: brown; width: 50%" 
                                        id="submit-button" 
                                        name="submit-button" 
                                        value="ادخال" hidden=true></input>
                            </div>
                        </form>
                    </div>
                </div>

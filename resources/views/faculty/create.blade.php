...
<div class="min-h-screen flex place-items-center justify-center bg-gray-50  px-4">
    <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md" dir="rtl">
        ...
        <div class="mb-6 text-center">
            <h2 class="text-xl font-bold text-gray-800">اضافة كليه جديدة</h2>
        </div>
        <form class="user" id="regForm" method="POST" action="{{ route('faculty.insert') }}">
            @csrf
            <div class="space-y-6">
                <!-- Input Field -->
                <div class="relative">
                ...
                <div class="flex justify-center">
                    <input type="submit" id="submit-button" value="إضافة الكلية"

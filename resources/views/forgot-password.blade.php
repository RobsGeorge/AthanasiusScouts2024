...
<head>
    ...
    <title>Athanasius Scouts - Forgot Password</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5" style="margin-top: 100px;">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" style="font-family: 'Cairo', sans-serif;" href={{ url('/register') }}>انشاء حساب جديد</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" style="font-family: 'Cairo', sans-serif;" href={{ url('/login') }}>لديك حساب بالفعل؟ قم بتسجيل الدخول</a>
                                    </div>
                                </div>
                            </div>
                        </div>

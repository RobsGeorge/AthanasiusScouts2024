                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <div class="form-group text-center" dir="rtl">
                                    <label class="text-center" for="person_job" style="font-family: 'Cairo', sans-serif;">نوع الوظيفة</label>
                        ...
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <div class="form-group text-center" dir="rtl">
                                        ...
                                        <option style="font-family: 'Cairo', sans-serif; color: black; font-size: large" value="" disabled selected> اختر القطاع</option>

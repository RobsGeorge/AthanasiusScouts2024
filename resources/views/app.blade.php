                        ...
                        <form class="user" id="regForm" method="POST" action="{{ route('entry-questions.insert') }}">
                            ...
                            <div class="card-header py-3">
                                <div class="">
                                        ...
                                        <select class="form-control" style="margin-top: 8px;" name="marhala_id" id="marhala_id" onselect="" placeholder="اختار المرحلة الدراسية">
                                        ...
                                        <br>
                                        <input type="submit" class="btn-google btn-user btn-block" style="background-color: brown;" id="submit-button" onsubmit="validateData()" value="تأكيد ادخال السؤال"></input>
                                </div>
                            </div>
                        </form>
                    </div>

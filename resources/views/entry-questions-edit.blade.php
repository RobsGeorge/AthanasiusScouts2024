        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <form class="user" id="regForm" method="post" action="{{ route('entry-questions.update', $entryQuestions->QuestionID) }}">
                            @method('PATCH')
                            @csrf
                            <div class="card-header py-3">
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                ...
                                                @foreach($marahel as $marhala)
                                                    @if($entryQuestions->MarhalaID == $marhala->MarhalaID)                                            
                                                        <input type="text" name="marhala_id" id="marhala_id" value="{{$marhala->MarhalaName}}" disabled>
                                                        @break
                                                    @endif
                                                @endforeach
                                                
                                                <br>
                                                <label>ID = {{$entryQuestions->QuestionID}}</label>
                                                <br>
                                                <select class="form-control" style="margin-top: 8px;" name="required_answer_type" id="required_answer_type" onChange="" placeholder=" نوع السؤال">
                                                <option style="font-family: 'Cairo', sans-serif; color: black; font-size: large" value="{{$entryQuestions->RequiredAnswerType}}" selected>{{$entryQuestions->RequiredAnswerType}}</option>
                                            ...
                                            placeholder="تعديل نص السؤال" value="{{$entryQuestions->QuestionText}}">
                                                    <br>

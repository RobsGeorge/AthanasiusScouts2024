                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">تعديل حدث/مناسبة كشفية</h6>
                        </div>
                    </div>
                                ...
                                <div class="col mb-3 mb-sm-0">
                                    <div class="card-header">        
                                        <div class="form-group" dir="rtl" style="text-align: right">
                                            <label for="eventtype" style="font-family: 'Cairo', sans-serif;">تعديل نوع الحدث أو المناسبة الكشفية</label>
                                            <br />
                                            <select class="form-control col-sm-4" style="margin-right: 20px;" name="event_type_id" id="event_type_id">
                                                <option style="font-family: 'Cairo', sans-serif; color: black; font-size: large" value="" disabled selected>{{$event->EventTypeName}}</option>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 mb-3 mb-sm-0" dir="rtl" style="text-align: right">
                                                ...
                                                <input type="text" class="form-control form-control-user" name="event_name" id="event_name" style="font-family: 'Cairo', sans-serif; font-size: medium"
                                                        placeholder="ادخل اسم الحدث أو المناسبة" onfocusout="myFunction()" value="{{$event->EventName}}">
                                            </div>
                                            <div class="col-sm-6 mb-3 mb-sm-0" dir="rtl" style="text-align: right">
                                                <label>القطاعات المربوطة حالياً هي: {{$event->EventQetaat}}</label>
                                                <label for="qetaatnames" style="font-family: 'Cairo', sans-serif;">تغيير القطاعات المربوطة بهذا الحدث (اختر كل القطاعات التي تريدها ان تكون مربوطة بعد التعديل <strong>**لا تتركها فارغة حتى اذا كنت تريد أن تترك القطاعات المربوطة كما هي بدون تغيير**</strong>)</label>
                                                <br />
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 mb-3 mb-sm-0"  dir="rtl" style="text-align: right">    
                                                <label  class="text-center" for="event_start_date" style="font-family: 'Cairo', sans-serif;">تعديل تاريخ بداية الحدث</label>
                                                <input type="date" class="form-control form-control-user" id="event_start_date" name="event_start_date" style="margin-left: 5px;;font-family: 'Cairo', sans-serif; font-size: large"
                                                    placeholder="تاريخ بداية الحدث أو المناسبة" value="{{$event->EventStartDate}}">
                                            </div>

                                            <div class="col-sm-6 mb-3 mb-sm-0"  dir="rtl" style="text-align: right">    
                                                <label  class="text-center" for="event_end_date" style="font-family: 'Cairo', sans-serif;">تعديل تاريخ نهاية الحدث</label>
                                                <input type="date" class="form-control form-control-user" id="event_end_date" name="event_end_date" style="margin-left: 5px;;font-family: 'Cairo', sans-serif; font-size: large"
                                                    placeholder="تاريخ نهاية الحدث أو المناسبة" value="{{$event->EventEndDate}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>

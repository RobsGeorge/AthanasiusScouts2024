                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    @if($isKhadem)<h6 class="m-0 font-weight-bold text-primary">ربط الخدام بالمجموعات
                                    </h6>
                            ...
                            <div class="card shadow mb-4">
                                <form class="user" id="regForm" method="POST"
                                    action="{{ route('group-person.insert') }}">
                                    @csrf
                                    <div class="card-header py-3">
                                        <div class="col mb-3 mb-sm-0">
                                            <div class="card-header">
                                                <div class="form-group" dir="rtl" style="text-align: right">
                                                    <label for="group_id" style="font-family: 'Cairo', sans-serif;">اختر
                                                        المجموعة الكشفية</label>
                                                    <br />
                                                    <select class="form-control col-sm-4" style="margin-right: 20px;"
                                                        ...
                                                        <option
                                                            ...
                                                            value="" disabled selected>اختر المجموعة الكشفية</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0" dir="rtl"
                                                        ...
                                                        <label for="person_id"
                                                            style="font-family: 'Cairo', sans-serif;">اختر الاسم او
                                                            الكود الخاص بالشخص/الأشخاص للربط</label>
                                                        <br />
                                                        <select class="form-control col-sm-4" multiple="multiple"
                                                            style="width: 75%; margin-right: 20px;" name="person_id[]"
                                                            id="person_id">
                                                            @foreach($persons as $person)
                                                            <option
                                                                style="font-family: 'Cairo', sans-serif; color: black;"
                                                                value="{{$person->PersonID}}">{{$person->FullName}}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-6 mb-3 mb-sm-0" dir="rtl"
                                                        style="text-align: right">
                                                        <label for="group_role_id"
                                                            style="font-family: 'Cairo', sans-serif;">اختر دور الشخص في
                                                            المجموعة</label>
                                                        <br />
                                                        <select class="form-control col-sm-4"
                                                            style="width: 75%; margin-right: 20px;" name="group_role_id"
                                                            id="group_role_id">
                                                            <option
                                                                style="font-family: 'Cairo', sans-serif; color: black; font-size: large"
                                                                value="" disabled selected>اختر دور الشخص</option>
                                                            @foreach($groupRoles as $groupRole)
                                                            <option
                                                                style="font-family: 'Cairo', sans-serif; color: black;"
                                                                value="{{$groupRole->GroupRoleID}}">
                                        ...
                                        <input type="submit" class="btn-google btn-user btn-block"
                                            style="background-color: brown; width: 50%" id="submit-button"
                                            value="ادخال"></input>
                                    </div>
                                </form>
                            </div>

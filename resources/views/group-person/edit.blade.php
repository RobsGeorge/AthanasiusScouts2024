                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">تعديل ربط شخص بمجموعة</h6>
                        </div>
                    </div>

                    <div class="card shadow mb-4">
                        <form class="user" id="regForm" method="post" action="{{ route('group-person.update', $personGroupRoleRow->PersonGroupRoleID) }}">
                            @method('PATCH')
                            @csrf
                            <div class="card-header py-3">
                                <div class="col mb-3 mb-sm-0">
                                    <div class="card-header">        
                                        <div class="form-group" dir="rtl" style="text-align: right">
                                            <label for="group_id" style="font-family: 'Cairo', sans-serif;">المجموعة الكشفية</label>
                                            <br />
                                            <select class="form-control col-sm-4" style="margin-right: 20px;" name="group_id" id="group_id">
                                                <option style="font-family: 'Cairo', sans-serif; color: black; font-size: large" value="{{$selectedGroup->GroupID}}" selected>{{$selectedGroup->GroupInfo}}</option>
                                                @foreach($groups as $group)
                                                    <option style="font-family: 'Cairo', sans-serif; color: black; font-size: large" value="{{$group->GroupID}}">{{$group->GroupInfo}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6 mb-3 mb-sm-0" dir="rtl" style="text-align: right">
                                                <label for="khadem_id" style="font-family: 'Cairo', sans-serif;">الاسم و الكود الخاص بالشخص</label>
                                                <br />
                                                <label name="person_id" id="person_id" type="text" style="font-family: 'Cairo', sans-serif; color: black;" value="{{$person->PersonID}}">{{$person->FullName}}</option>
                                            </div>
                                            <div class="col-sm-6 mb-3 mb-sm-0" dir="rtl" style="text-align: right">
                                                @if($isKhadem)
                                                ...
                                                <select class="form-control col-sm-4" style="width: 75%; margin-right: 20px;" name="group_role_id" id="group_role_id">
                                                    <option style="font-family: 'Cairo', sans-serif; color: black; font-size: large" value="{{$selectedGroupRole->GroupRoleID}}" selected>{{$selectedGroupRole->GroupRoleName}}</option>
                                ...
                                <input type="submit" class="btn-google btn-user btn-block" style="background-color: brown; width: 50%" id="submit-button" value="تعديل"></input>
                            </div>
                        </form>
                    </div>
                </div>

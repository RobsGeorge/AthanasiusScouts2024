...
//Routes for Max Numbers
Route::get('/max-numbers', array('as'=> 'max-numbers.index', 'uses'=>'App\Http\Controllers\MaxNumbersController@index'));
Route::get('/max-numbers/add', array('as' => 'max-numbers.create', 'uses' =>'App\Http\Controllers\MaxNumbersController@create'));
Route::post('/max-numbers/insert', array('as' => 'max-numbers.insert', 'uses' => 'App\Http\Controllers\MaxNumbersController@insert'));
Route::get('/max-numbers/edit/{id}', array('as' => 'max-numbers.edit', 'uses' => 'App\Http\Controllers\MaxNumbersController@edit'));
Route::patch('/max-numbers/update/{id}', array('as'=> 'max-numbers.update', 'uses'=> 'App\Http\Controllers\MaxNumbersController@updates'));
Route::get('/max-numbers/delete/{id}', array('as'=> 'max-numbers.delete', 'uses'=>'App\Http\Controllers\MaxNumbersController@deletes'));
Route::delete('/max-numbers/destroy/{id}', array('as'=> 'max-numbers.destroy', 'uses'=>'App\Http\Controllers\MaxNumbersController@destroy'));

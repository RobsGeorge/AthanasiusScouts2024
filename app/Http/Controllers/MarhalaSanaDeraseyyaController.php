...
class MarhalaSanaDeraseyyaController extends Controller
{
/**
        ...
        */
        ...
        {
            $sana = DB::table('Sana')->get();
            $marhala = DB::table('Marhala')->get();
            return view("marhala-sana-index", array('marhala' => $marhala, 'sana' => $sana, 'title'=> "الرتب الكشفية"));
        }
